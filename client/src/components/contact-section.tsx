            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4" data-testid="contact-info-email">
                ...
                <div>
                  ...
                  <p className="text-slate-grey dark:text-muted-foreground">alex.chen@university.edu</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4" data-testid="contact-info-linkedin">
                ...
                <div>
                  ...
                  <p className="text-slate-grey dark:text-muted-foreground">/in/alex-chen-ai</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4" data-testid="contact-info-github">
                ...
                <div>
                  ...
                  <p className="text-slate-grey dark:text-muted-foreground">/alexchen-ai</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4" data-testid="contact-info-location">
                ...
                <div>
                  ...
                  <p className="text-slate-grey dark:text-muted-foreground">San Francisco Bay Area</p>
                </div>
              </div>
            </div>
